...
export default function Book({ book }) {  
  return (  
    <div className="flex flex-col justify-between border rounded-lg shadow-md overflow-hidden w-full max-w-xs transition-transform transform hover:scale-105">  
      <img  
      ...
      <div className="flex flex-col p-3 flex-grow bg-white">  
        <div className="text-red-600 text-xl font-semibold mb-1">  
          {book.price}đ <span className="text-gray-500 text-sm">-15%</span>  
        </div>  
        <div className="text-gray-700 text-lg font-semibold mb-2">{book.name}</div>  
